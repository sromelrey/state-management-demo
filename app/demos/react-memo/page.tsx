    ...
    <Card className='border-red-200'>
      ...
      <CardContent className='space-y-2'>
        ...
        <p className='text-xs text-muted-foreground'>
          🔴 Re-renders every time parent renders, even when prop doesn&apos;t
          change
        </p>
        <CodeViewer
          code={REGULAR_CHILD_CODE}
          title='View Child Implementation'
        />
      </CardContent>
    </Card>
  );
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Interactive Comparison</CardTitle>
        <CardDescription>
          Parent component that renders both child types
        </CardDescription>
      </CardHeader>
      <CardContent className='space-y-4'>
        <div className='bg-muted p-4 rounded'>
          <RenderCounter
            ...
            count={parentRenderCount.current}
          />
        </div>
        ...
        <div className='grid md:grid-cols-2 gap-4'>
          ...
          <MemoizedChild
            value={childValue}
            renderCount={memoizedChildRenders}
          />
        </div>
        ...
        <div className='bg-yellow-50 dark:bg-yellow-950 p-4 rounded-lg'>
          ...
          <p className='text-sm text-muted-foreground'>
            Click &quot;Update Parent State (Unrelated)&quot; and watch what
            happens:
          </p>
          <ul className='list-disc list-inside text-sm text-muted-foreground mt-2 space-y-1'>
            <li>
              Regular Child: render count increases even though its prop
              didn&apos;t change
            </li>
            <li>
              Memoized Child: render count stays the same! The prop hasn&apos;t
              changed, so no re-render
            </li>
          </ul>
        </div>
...
// compare only specific fields you care about`}
          ...
          <p className='text-sm text-muted-foreground mt-3'>
            By default, React.memo does shallow comparison. You can provide a
            custom comparison function for more control over when re-renders
            should happen.
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent className='space-y-4'>
          <div className='bg-green-50 dark:bg-green-950 p-4 rounded-lg'>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm text-muted-foreground'>
              ...
              <li>
                Pure functional components that don&apos;t depend on context
              </li>
            </ul>
          </div>
          ...
          <div className='bg-red-50 dark:bg-red-950 p-4 rounded-lg'>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm text-muted-foreground'>
              ...
              <li>
                When props include functions/objects that change on every render
          ...
          <div className='bg-orange-50 dark:bg-orange-950 p-4 rounded-lg'>
            ...
            <p className='text-sm text-muted-foreground mb-2'>
              React.memo won&apos;t help if you pass new object/array/function
...
function Parent() {
  ...
  return <MemoChild onClick={handleClick} />;
          ...
          <div className='bg-blue-50 dark:bg-blue-950 p-4 rounded-lg'>
            ...
            <p className='text-sm text-muted-foreground'>
              React.memo is a <strong>higher-order component</strong> that wraps
              your component. It&apos;s different from useMemo (memoizes values)
              and useCallback (memoizes functions). Use all three together for
              maximum optimization of expensive components.
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className='space-y-4'>
          <div className='bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border-l-4 border-blue-500'>
            <p className='font-semibold mb-2'>
              📦 Phase 1: Creation Phase (Parent Renders)
            </p>
            <p className='text-sm text-muted-foreground mb-2'>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm text-muted-foreground'>
              ...
              <li>
                Parent&apos;s JSX includes{" "}
                <code className='bg-muted px-1 rounded'>{`<MemoizedChild value={...} />`}</code>
              </li>
          ...
          <div className='bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border-l-4 border-green-500'>
            <p className='font-semibold mb-2'>
              ⚡ Phase 2: Execution Phase (Shallow Comparison)
            </p>
            <p className='text-sm text-muted-foreground mb-2'>
    ...
    return true;  // Props are the same
          ...
          <div className='bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border-l-4 border-purple-500'>
            ...
            <div className='text-sm text-muted-foreground space-y-2'>
              ...
              <div className='flex items-center gap-2'>
                <span className='font-mono'>2.</span> React checks: Are props
                === previous props?
              </div>
              <div className='grid md:grid-cols-2 gap-4 mt-2'>
                <div className='bg-green-50 dark:bg-green-900/30 p-3 rounded'>
                  ...
                  <p className='text-xs'>
                    Child&apos;s function is <strong>NOT called</strong>
                    <br />
                    No new execution context created
                    <br />
                    Previous render result reused
                    <br />
                ...
                <div className='bg-red-50 dark:bg-red-900/30 p-3 rounded'>
                  <p className='font-semibold mb-1'>
                    ❌ NO (different references):
                  </p>
                  <p className='text-xs'>
                    Child&apos;s function <strong>IS called</strong>
                    <br />
          ...
          <div className='bg-orange-50 dark:bg-orange-950 p-4 rounded-lg'>
            ...
            <p className='text-sm text-muted-foreground'>
              Remember: <code className='bg-muted px-1 rounded'>===</code>{" "}
              compares memory addresses! A new function object has a different
              address even if the code is identical. That&apos;s why{" "}
              <strong>useCallback + React.memo</strong> must work together.
            </p>
          </div>
        </CardContent>
      </Card>
