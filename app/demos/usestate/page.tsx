    ...
    <div className='space-y-6 max-w-4xl mx-auto'>
      <div>
        ...
        <p className='text-muted-foreground mt-2'>
          Traditional React approach using useState and passing props down the
          component tree
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How this useState implementation works
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-4'>
          ...
          <div>
            ...
            <ul className='list-disc list-inside space-y-1 text-sm text-muted-foreground'>
              <li>
                <strong>Props Drilling</strong> - must pass props through
                intermediate components
              </li>
              <li>
                State must live in common ancestor (often very high in tree)
              </li>
          ...
          <div className='bg-red-50 dark:bg-red-950 p-4 rounded-lg'>
            ...
            <p className='text-sm text-muted-foreground mb-2'>
              Notice the orange &quot;Middleware Component&quot; above? It
              doesn&apos;t use the count value at all, but it MUST receive it as
              a prop just to pass it down to its children.
            </p>
            <p className='text-sm text-muted-foreground'>
              Imagine this happening across 5-10 levels of components - this is
              why state management solutions exist! Every other approach in this
              demo solves this problem in different ways.
            </p>
          </div>

          <div className='bg-blue-50 dark:bg-blue-950 p-4 rounded-lg'>
            <p className='text-sm font-semibold mb-2'>
              💡 When to Use useState + Props:
            </p>
            <ul className='list-disc list-inside space-y-1 text-sm text-muted-foreground'>
